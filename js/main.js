...
// --- Academy Accordion Logic ---
document.addEventListener('DOMContentLoaded', () => {
    const courseItems = document.querySelectorAll('.course-item');
    console.log('Accordion items found:', courseItems.length);

    courseItems.forEach(item => {
        item.addEventListener('click', () => {
            console.log('Course item clicked:', item.querySelector('span').innerText);
            ...
            console.log('Active class present:', item.classList.contains('active'));
        });
    });
});
